namespace GraphicsWar.ExtensionMethods
{
    ...
    /// 
    /// </summary>
    public static partial class MyMeshes
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static T CreateCornellBox<T>(float roomSize = 2, float sphereRadius = 0.3f, float cubeSize = 0.6f) where T : DefaultMesh, new()
        {
            var mesh = new T();
            //off-center plane
        ...
        /// <summary>
        /// Same as generic method, but defaults to a standard DefaultMesh
        /// </summary>
        /// <returns></returns>
        public static DefaultMesh CreateCornellBox(float roomSize = 2, float sphereRadius = 0.3f, float cubeSize = 0.6f)
        {
            return CreateCornellBox<DefaultMesh>(roomSize, sphereRadius, cubeSize);
        }
        ...
        /// </returns>
        public static T CreateCubeWithNormals<T>(float size = 1.0f) where T : DefaultMesh, new()
        {
            var m = new T();
        ...
        {
            return CreateCubeWithNormals<DefaultMesh>(size);
        }
        ...
        /// Mesh with positions, ids, normals
        /// </returns>
        public static T CreateSphere<T>(float radius = 1.0f, uint subdivision = 1) where T : DefaultMesh, new()
        {
            var m = new T();
        ...
        {
            return CreateSphere<DefaultMesh>(radius, subdivision);
        }
        ...
        /// Mesh with positions, ids, normals
        /// </returns>
        public static T CreateIcosahedron<T>(float radius) where T : DefaultMesh, new()
        {
            return CreateSphere<T>(radius, 0);
        }
        ...
        {
            return CreateSphere<DefaultMesh>(radius, 0);
        }
        ...
        /// </returns>
        public static T CreatePlane<T>(float sizeX = 1.0f, float sizeZ = 1.0f, uint segmentsX = 1, uint segmentsZ = 1) where T : DefaultMesh, new()
        {
            var m = new T();
        ...
        /// </summary>
        /// <returns></returns>
        public static DefaultMesh CreatePlane(float sizeX = 1.0f, float sizeZ = 1.0f, uint segmentsX = 1, uint segmentsZ = 1)
        {
            return CreatePlane<DefaultMesh>(sizeX, sizeZ, segmentsX, segmentsZ);
        }
    }
}
